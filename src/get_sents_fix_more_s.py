            ...
            if a == name:
                ...
                for r in range(e_n):
                    if ner[r + i].startswith('B') or ner[r + i].startswith('I') \
                            or ner[r + i].startswith('E') or ner[r + i].startswith('S'):
                        flag = True
                        break
...
if __name__ == '__main__':
    ...
    f.close()
    data_dump(datas, '../datasets/256_s/example_ner_no_emotion.pkl')
    data_dump(datas_em, '../datasets/256_s/example_ner_has_emotion.pkl')
    ...
    f.close()
    data_dump(datas, '../datasets/256_s/train_ner_no_emotion.pkl')
    data_dump(datas_em, '../datasets/256_s/train_ner_has_emotion.pkl')
    ...
    f.close()
    data_dump(datas, '../datasets/256_s/test_ner2.pkl')
